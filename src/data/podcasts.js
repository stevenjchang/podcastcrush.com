...
export const podcasts = [
  ...
  },
  {
    name: 'The Pitch',
    description:
      'A show where real entrepreneurs pitch to real investors—for real money", the podcast aims to capture the essence of what happens when entrepreneurs pitch investors.',
    imageUrl: getImagePath('the_pitch.jpeg'),
    categories: ['entrepreneurship'],
  },
  {
    name: 'Plain English',
    description:
      'Longtime Atlantic tech, culture and political writer Derek Thompson cuts through all the noise surrounding the big questions and headlines that matter to you in his new podcast Plain English.',
    imageUrl: getImagePath('plain_english.jpeg'),
    categories: ['general'],
  },
  {
    name: 'Smart Agency Masterclass',
    description:
      'Bi-weekly interviews, strategy, and advice for building your marketing agency the smart way.',
    imageUrl: getImagePath('smart_agency_masterclass.png'),
    categories: ['entrepreneurship'],
  },
  // {
  //   name: 'Equity',
...

  {
    ...
    categories: ['economics', 'startup', 'entrepreneurship'],
  },
  // {
